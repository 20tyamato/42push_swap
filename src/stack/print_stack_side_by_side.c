...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   print_stack_side_by_side.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: 20tyamato <20tyamato@student.42.fr>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/29 12:42:34 by 20tyamato         #+#    #+#             */
/*   Updated: 2025/01/29 12:42:34 by 20tyamato        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_side_by_side_row(t_list **current1, t_list **current2)
{
	if (*current1)
	{
...
void	print_stack_side_by_side(t_stack *stack1, t_stack *stack2)
{
	...
	while (current1 || current2)
		print_side_by_side_row(&current1, &current2);
